        ...
        <div className="grid lg:grid-cols-[50%_50%] gap-16 items-center">
          ...
          <div className="flex ">
            <div className="bg-[#1E1E1E] rounded-[20px] py-8 px-8 w-[100%] md:w-[67%] h-[272px]">
              {/* Header */}
              <div className="mb-6">
                <p className="text-dark-mode-secondaryText text-2xl font-[700] mb-5">Current Balance</p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-dark-mode-secondaryText text-3xl md:text-4xl font-[600]">≈$234.53</span>
