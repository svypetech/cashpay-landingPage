...
export default function WhyCashpay({features}: { features: SwapFeature[] }) {
 

  return (
    <section className="py-25 bg-white w-full px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-lg mb-8">
          Trusted by thousands for its simplicity, security, and innovation.
        </p>
